  ...
  methods: {
      ...
      axios
        ...
        .then(res => {
          ...
          if (res.data.status == 200303) {
            ...
            this.$message.error(
              "挂号失败" + res.data.msg.error + res.data.status
            );
          }
        })
        .catch(error => {
    ...
    querySearch_m(queryString, cb) {
      ...
      var results = queryString
        ? restaurants.filter(this.createFilter_m(queryString))
        : restaurants;
    ...
    querySearch_w(queryString, cb) {
      ...
      var restaurants = this.sourceArr;
      var results = queryString
        ? restaurants.filter(this.createFilter_w(queryString))
        : restaurants;
      // 调用 callback 返回建议列表的数据
      cb(results);
    },
    ...
    getSubject_m() {
      ...
      axios
        .get(
          baseUrl + "api/mq/register_type_new?hospital=" + this.hospitalIndex_m
        )
        .then(res => {
          console.log(res);
    ...
    orderSelect_m() {
      ...
      if (this.orderTypeNum_m == "") {
        ...
        axios
          .get(baseUrl + "api/mq/depart_doctor?depart_code=" + this.roomId_m)
          .then(res => {
            console.log(res);
    ...
    getSubject_w() {
      ...
      axios
        .get(
          baseUrl + "api/mq/register_type_new?hospital=" + this.hospitalIndex_w
        )
        .then(res => {
          console.log(res);
          if (res.data.status == 200302) {
    ...
    orderSelect_w() {
      ...
      if (this.orderTypeNum_w == "") {
        ...
        axios
          .get(baseUrl + "api/mq/depart_doctor?depart_code=" + this.roomId_w)
          .then(res => {
            console.log(res);
