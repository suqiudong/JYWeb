  ...
  methods: {
    ...
    icCardBulr() {
      if (this.treatId == "") {
        ...
        axios
          .get(baseUrl + "api/mq/search_patient?keyword=" + this.treatId)
          .then(res => {
            console.log(res);
    ...
    engenderBtn() {
      ...
      if (this.radio == 1 && this.indexId != "") {
        ...
        axios
          .get(
            baseUrl + "api/his/book_subject_list?hospital_no=" + this.indexId
          )
          .then(res => {
            // console.log(res);
            // console.log(this.radio);
        ...
        // 选择非生殖用户时请求接口
        axios
          .get(baseUrl + "api/mq/register_type?hospital=" + this.indexId)
          .then(res => {
            console.log(res);
    ...
    getSubject() {
      ...
      axios
        .get(baseUrl + "api/mq/register_type_new?hospital=" + this.hospitalNum)
        .then(res => {
          console.log(res);
