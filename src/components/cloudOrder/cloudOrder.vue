        ...
        <div class="cloudOrder_main">
            ...
            <ul class="clear" style="border-top: 1px dashed #ccc;margin-top:5%;padding-top:5%">
                ...
                <li>
                    ...
                    <el-select v-model="roomId" :disabled="roomDisabled" clearable v-on:change="roomSelect" style="width:60%" filterable placeholder="请选择" :filterMethod="roomFilter">
                        <el-option v-for="item in roomArr"  :key="item.ItemName"  :label="item.ItemName" :value="item.itemNo">
                ...
                <li>
                    ...
                    <el-date-picker
                        ...
                        value-format="yyyy-MM-dd" v-on:change="dateSelect" :picker-options="pickerOptions0"  v-bind:disabled="dateDisabled">
                    </el-date-picker>
                </li>
                <li>
    ...
    export default {
        data(){
            return{
                ...
                timeArr: [],//时间
                sourceArr: [
                    {name:"PYJS",value:"朋友介绍"},{name:"ARZY",value:"爱人在院"},{name:"YSJS",value:"医生介绍"},
        ...
        methods: {
            ...
            inquire(){
                if(this.treatId == ''){
                    ...
                    axios.get(baseUrl + "api/mq/search_patient?keyword=" + this.icCard)
                    .then(res=>{
                        console.log(res);
            ...
            hospitalSelect(){
                ...
                if(this.hospitalNum != ''){
                     ...
                     axios.get(baseUrl + 'api/his/book_subject_list?hospital_no=' + this.hospitalNum)
                    .then(res=>{
                        console.log(res);
            ...
            roomSelect(){
                ...
                if(this.roomId != ''){
                    axios.get(baseUrl + 'api/his/book_date_list?item_no=' + this.roomId)
                    .then(res=>{
                        console.log(res);
            ...
            dateSelect(){
                ...
                if(this.date != ''){
                    axios.get(baseUrl + "api/his/book_doctor_list?item_no=" + this.roomId + '&registered_start_date=' + this.date + '&registered_end_date=' + this.date, )
                    .then(res=>{
                        console.log(res);
            ...
            timeSelect(){
                ...
                if(this.time != ''){
                    axios.get(baseUrl + "api/his/book_doctor_schedule_list?item_no=" + this.roomId + '&registered_start_date=' + this.date + '&registered_end_date=' + this.date + '&doctor_no=' + this.time)
                    .then(res=>{
                        console.log(res);
            ...
            order(){
                if(this.icCard == '' || this.name == ''){
                    ...
                    axios.post(baseUrl + "api/his/add_book_queue", JSON.stringify({
                        item_no: this.roomId,
                        identify_no: this.idCard,
                        visit_card: this.icCard,
                        registered_date: this.date,
                        doctor_no: this.time[0],
                        time_no: this.timeId[1],
                        scheduling_no: this.timeId[2]
                    })).then(res=>{
                        console.log(res);
                        ...
                        if(res.data.status == 2002010){
                            ...
                            this.tipsMsg = "挂号失败:" + res.data.desc + res.data.status + res.data.msg.error;
                            this.popshow = true;  
                        }else{
