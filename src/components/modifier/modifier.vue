            ...
            <div class="main_right clear">
                ...
                <ul class="clear">
                    ...
                    <li>
                        ...
                        <el-button  type="warning" style="float:right"  @click="getCode" v-bind:disabled="getcodeDisabled"  v-loading.fullscreen.lock="loading">
...
export default {
  data() {
    return {
      ...
      sendMsgDisabled: false, //获取验证码的disabled
      time: 60 //
    };
  },
  methods: {
    ...
    getDeviceMsg() {
      ...
      if (this.deviceInput == "" || this.deviceInput == null) {
        ...
        if (data.PHYSI_SEX_NAME == "男") {
          axios
            .get(baseUrl + "api/sensetime/data/" + this.deviceInput + "/listm")
            .then(res => {
              console.log(res);
              if (res.data.status == 200040) {
                this.deviceMsgArr = res.data.msg;
          ...
          axios
            .get(baseUrl + "api/sensetime/data/" + this.deviceInput + "/listw")
            .then(res => {
              console.log(res);
              if (res.data.status == 200040) {
                this.deviceMsgArr = res.data.msg;
    ...
    getCode() {
      ...
      if (!phoneReg.test(this.newPhone)) {
        ...
        this.loading = true;
        axios
          .get(baseUrl + "api/auth/verify/check/" + this.newPhone)
          .then(res => {
            console.log(res);
            this.loading = false;
    ...
    changePhone() {
      ...
      if (!phoneReg.test(this.newPhone)) {
        ...
        axios
          .post(
            baseUrl + "api/auth/sms_code/is_valid",
            JSON.stringify({
              phone: this.newPhone,
              sms_code: this.code
            })
          ...
          .then(res => {
            ...
            if (res.data.status == 200027) {
              ...
              this.loading = true;
              axios
                .post(baseUrl + "api/mq/modify_patient", data)
                .then(res => {
                  console.log(res);
                  this.loading = false;
    ...
    confirmBtn() {
      ...
      if (this.newPhone != "") {
        axios
          .post(baseUrl + "api/mq/modify_patient", newData)
          .then(res => {
            console.log(res);
            this.loading = false;
            if (res.data.status == 200320) {
        ...
        .then(res => {
          ...
          if (res.data.status == 200004) {
            if (res.data.msg.id_image != "" && res.data.msg.face_image != "") {
              ...
              res.data.msg.face_image == "" &&
              res.data.msg.id_image != ""
            ) {
              this.idImg = res.data.msg.id_image;
              this.newIdImg = res.data.msg.id_image;
